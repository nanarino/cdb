...
urlpatterns = [
    ...
    url(r'^music/listen/$', views.music_listen),
    ...
    url(r'^relaxation/addAlbum/$', views.relaxation_add_album),
    url(r'^relaxation/ownSpace/$', views.relaxation_own_space),
    url(r'^staff/$', views.staff),
    url(r'^staff/introduction/$', views.staff_introduction),
